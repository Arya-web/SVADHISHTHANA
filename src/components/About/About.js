  ...
  return (
    <>
      <div
        ...
        name="about"
      >
        <div className="order-1 md:order-2 md:w-[75%] py-8">
          <div className="flex justify-center items-center h-full">
            <div className="flex">
              <div className="px-8 md:px-8 lg:px-10">
                <div className="text-center">
                  <p className="font-body tracking-wider font-semibold text-green-600 pt-2">
                    ABOUT US
                  </p>
